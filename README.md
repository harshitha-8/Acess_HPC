...
- Capturing dual alternating gaps $(+, -, +)$ forces geometrically identical coverage boundaries to inadvertently encapsulate bounded core logic. This naturally constrains VC 