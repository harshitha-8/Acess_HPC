...
- Aligning boundary rings intersecting symmetric alternating elements (e.g., $P_1$ and $P_3$) successfully skips localized structural cores ($P_2$), mapping exactly all boolean permutations resolving the 16 state capacit